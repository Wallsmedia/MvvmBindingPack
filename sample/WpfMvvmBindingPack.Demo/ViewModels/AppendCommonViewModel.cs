...
{
    public class AppendCommonViewModel : NotifyChangesBase
    {
        [ViewXNameAlias("TextOfTitleApnd","Content")]
        private static string _textOfTitle = "AppendCommonViewModel-Title binding Example from Append to View Model";
    }
}
