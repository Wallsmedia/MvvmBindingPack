...
namespace WpfMvvmBindingPack.DemoUW10.ViewModels
{
    public class AutoBindingViewModel : NotifyPropertyChangedBase
    {
        [ViewXNameAlias("TextOfTitle", "Text")]
        ...
        public void EnableDisable_Click(object o, RoutedEventArgs e)
        {
            AllFuncButtonsState = !AllFuncButtonsState;
        }

        [ViewXNameAlias("IncCounterClick", "Click")]
        public void IncCounterClickMethod(object o, RoutedEventArgs e)
        {
            CountClick_Text++;
        }

        [ViewXNameAlias("IncCounterCmd", "Click")]
        public void IncCounterCmdMethod(object o, RoutedEventArgs e)
        {
            CountCmd++;
        }
